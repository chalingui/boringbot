...
function renderHeader(string $title): void
{
    ...
    echo '<style>
      ...
      pre{white-space:pre-wrap;word-break:break-word;background:rgba(0,0,0,.2);padding:10px;border-radius:10px;border:1px solid var(--line);max-height:420px;overflow:auto}
